  ...
  def __init__(self):
    ...
    for i in range(len(people_positions)-1):
      for  j in range(int(velocity)):
        c=int(i*len(people_positions) + j)
        positions.append(Point())
        positions[c].x=people_positions[i][0]+((people_positions[i][0]-people_positions[i+1][0]) * j / velocity)
        positions[c].y=people_positions[i][1]+((people_positions[i][1]-people_positions[i+1][1]) * j / velocity)
        positions[c].z=people_positions[i][2]+((people_positions[i][2]-people_positions[i+1][2]) * j /  velocity)
    orientation=[]
    for i in range(len(people_positions)-1):
      for  j in range(int(velocity)):
        c=int(i*len(people_positions) + j)
        orientation.append(Quaternion())
        orientation[c].x=people_positions[i][3]+((people_positions[i][3]-people_positions[i+1][3]) * j / velocity)
        orientation[c].y=people_positions[i][4]+((people_positions[i][4]-people_positions[i+1][4]) * j / velocity)
        orientation[c].z=people_positions[i][5]+((people_positions[i][5]-people_positions[i+1][5]) * j / velocity)
        orientation[c].w=people_positions[i][6]+((people_positions[i][6]-people_positions[i+1][6]) * j / velocity)
